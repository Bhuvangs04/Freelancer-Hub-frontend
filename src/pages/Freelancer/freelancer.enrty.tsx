        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 animate-in slide-up animate-delay-300">
              <Link
                to="/dashboard"
                className="px-8 py-3 bg-primary text-white rounded-lg shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30 hover:-translate-y-0.5 transition-all"
              >
                Go to Dashboard
              </Link>
              <Link
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              ...
              <p className="text-gray-500 mt-2">
                © 2023 TaskBridge. All rights reserved.
              </p>
            </div>
